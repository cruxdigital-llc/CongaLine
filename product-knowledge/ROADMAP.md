...
| **Egress — All providers** | Per-agent nginx proxy with SNI domain filtering. Local: validate (warn) or enforce modes. Remote/AWS: always enforce. Unified mechanism. | ✅ Complete — `specs/2026-03-25_feature_egress-allowlist/` |
