...
```
/conga/agents/aaron   → {"type":"user","slack_member_id":"UA13HEGTS","gateway_port":18789,"iam_identity":"aaronstone"}
/conga/agents/zach    → {"type":"user","slack_member_id":"U01UNLBCWNR","gateway_port":18790,"iam_identity":"zachhendershot"}
/conga/agents/devops  → {"type":"team","slack_channel":"C0ALL272SV8","gateway_port":18800}
```

### Config namespace

```
/conga/config/conga-image → "167595588574.dkr.ecr.us-east-2.amazonaws.com/conga:latest"
```
...
|-------|------|-----------|----------|---------------|--------------|
| aaron | `aaron` | `conga-aaron` | `/opt/conga/data/aaron/` | `conga-aaron` | `conga-aaron.service` |
| devops | `devops` | `conga-devops` | `/opt/conga/data/devops/` | `conga-devops` | `conga-devops.service` |

### Per-agent secrets

Unified path for all agent types:
- `conga/agents/<name>/<secret_name>` (e.g., `conga/agents/aaron/anthropic-api-key`)
