...
```
/openclaw/agents/aaron   → {"type":"user","member_id":"UA13HEGTS","gateway_port":18789,"iam_identity":"aaronstone"}
/openclaw/agents/zach    → {"type":"user","member_id":"U01UNLBCWNR","gateway_port":18790,"iam_identity":"zachhendershot"}
...
Unchanged:
- User secrets: `openclaw/<member_id>/<secret_name>` (e.g., `openclaw/UA13HEGTS/anthropic-api-key`)
