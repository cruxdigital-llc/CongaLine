...
STATE_BUCKET="conga-terraform-state-167595588574"
...
terraform {
  backend "s3" {
    bucket         = "conga-terraform-state-167595588574"
...
output "state_bucket" {
  ...
  value       = "conga-terraform-state-167595588574"
}
...
| Scenario | Handling |
|---|---|
| S3 bucket name already taken globally | Resolved: suffixed with account ID (167595588574) |
