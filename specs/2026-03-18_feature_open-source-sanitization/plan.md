...
- `terraform/user-data.sh.tftpl`:
  - Replace hardcoded ECR repo (`167595588574.dkr.ecr...`) with `${openclaw_image}` template variable
...
- `cli/cmd/root.go`: Replace `UA13HEGTS` → `UXXXXXXXXXX`, `C0ALL272SV8` → `CXXXXXXXXXX` in validation error examples
