  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = [
        ...
        "arn:aws:secretsmanager:${var.aws_region}:${data.aws_caller_identity.current.account_id}:secret:conga/aaron/*"
      ]
    }]
  })
}
...
locals {
  ...
  aaron_secrets = {
    "conga/aaron/anthropic-api-key" = "Anthropic API key"
    "conga/aaron/gateway-token"     = "Conga Line gateway auth token"
    "conga/aaron/trello-api-key"    = "Trello API key"
    "conga/aaron/trello-token"      = "Trello token"
  }
...
read_secret "conga/aaron/anthropic-api-key" "Anthropic API Key"
read_secret "conga/aaron/gateway-token" "Gateway Auth Token"
read_secret "conga/aaron/trello-api-key" "Trello API Key"
read_secret "conga/aaron/trello-token" "Trello Token"
