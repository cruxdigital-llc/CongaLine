...
terraform state rm 'aws_secretsmanager_secret.openclaw["openclaw/aaron/anthropic-api-key"]'
terraform state rm 'aws_secretsmanager_secret.openclaw["openclaw/aaron/trello-api-key"]'
terraform state rm 'aws_secretsmanager_secret.openclaw["openclaw/aaron/trello-token"]'
terraform state rm 'aws_secretsmanager_secret_version.openclaw["openclaw/aaron/anthropic-api-key"]'
terraform state rm 'aws_secretsmanager_secret_version.openclaw["openclaw/aaron/trello-api-key"]'
terraform state rm 'aws_secretsmanager_secret_version.openclaw["openclaw/aaron/trello-token"]'
```
...
for SECRET_PATH in $USER_SECRETS; do
  ...
  # Convert secret name to env var: openclaw/aaron/anthropic-api-key → ANTHROPIC_API_KEY
