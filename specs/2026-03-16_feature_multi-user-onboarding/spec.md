...
terraform state rm 'aws_secretsmanager_secret.conga["conga/aaron/anthropic-api-key"]'
terraform state rm 'aws_secretsmanager_secret.conga["conga/aaron/trello-api-key"]'
terraform state rm 'aws_secretsmanager_secret.conga["conga/aaron/trello-token"]'
terraform state rm 'aws_secretsmanager_secret_version.conga["conga/aaron/anthropic-api-key"]'
terraform state rm 'aws_secretsmanager_secret_version.conga["conga/aaron/trello-api-key"]'
terraform state rm 'aws_secretsmanager_secret_version.conga["conga/aaron/trello-token"]'
```
...
for SECRET_PATH in $USER_SECRETS; do
  ...
  # Convert secret name to env var: conga/aaron/anthropic-api-key → ANTHROPIC_API_KEY
